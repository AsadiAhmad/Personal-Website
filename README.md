...
The sitemap has `frequently property` tag `changefreq` which shows the change frequently of each page helps search engines updated the index and rank of the website.
